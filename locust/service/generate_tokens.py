...
def get_tokens(host, paras):
    ...
    file_path = os.path.join('../token/', host.name +'1.csv' )
...
if __name__ == "__main__":
    try: 
        ...
        parser.add_argument('-c','--company', default='dev-cn', help='Setup the environment')
        parser.add_argument('-n','--channel', default='channel', help='Setup the ann/mm channel')
        parser.add_argument('-p','--pool', default=24, help='Setup the threading pools')
